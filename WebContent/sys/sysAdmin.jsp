...
<title>论坛后台管理</title>
	...
	<frameset rows="150px,*,30px" framespacing="0" border="0">
		<frame name="gggtop" src="${pageContext.request.contextPath }/sys/public/top.jsp" scrolling="no" noresize /> 
		<frameset cols="178px,*">
			<frame name="left" noresize src="${pageContext.request.contextPath }/sys/public/left.jsp" scrolling="yes" /> 
